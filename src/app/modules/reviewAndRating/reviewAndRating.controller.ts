...
import {
  addReviewRatingService,
  deleteReviewRatingService,
  getAllReviewRatingByServiceService,
  getAllReviewRatingByUserService,
  getAllReviewRatingService,
  getSingleReviewRatingService,
  updateReviewAndRatingService,
} from "./reviewAndRating.service";
import { IReviewRating } from "./reviewAndRating.interface";

//create review and rating
export const addReviewAndRating = catchAsync(
...
export const getSingleReviewAndRating = catchAsync(
  async (req: Request, res: Response) => {
...
export const getAllReviewAndRating = catchAsync(
  async (req: Request, res: Response) => {
...
export const getAllReviewAndRatingByUser = catchAsync(
  async (req: Request, res: Response) => {
    const { id } = req.params;
...
export const getAllReviewAndRatingByService = catchAsync(
  async (req: Request, res: Response) => {
    const { id } = req.params;
...
export const updateReviewAndRating = catchAsync(
  async (req: Request, res: Response) => {
...
export const deleteReviewAndRating = catchAsync(
  async (req: Request, res: Response) => {
    const { id } = req?.params;
